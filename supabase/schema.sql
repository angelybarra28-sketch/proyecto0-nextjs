...
create policy if not exists "Customers can read own record"
  on customers for select
  using (user_id = auth.uid());

create policy if not exists "Customers can read own credit accounts"
...
create policy if not exists "Customers can read own credit installments"
...
create policy if not exists "Customers can read own credit payments"
...
create policy if not exists "Customers can read own credit account items"
...
create policy if not exists "Customers can read own credit collection notes"
