  ...
  return (
    <div className={styles.section} style={{ marginBottom: '2rem' }}>
      ...
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem' }}>
        <input
          type="url"
          placeholder="https://www.tiendaenova.com.ar/product/... o https://www.fravega.com/p/..."
          value={url}
      ...
      <p style={{ fontSize: '0.85rem', color: '#888', marginBottom: '1rem' }}>
        Soportado: Enova, MitiendaNube, MercadoLibre y Fravega. Se extrae: nombre, descripción, imágenes y precio de referencia.
      </p>
