...
function categoryHref(label: string) {
  const knownCategories = Array.from(new Set(allProducts.map((product) => product.categoria)));
  ...
  const matchedCategory = knownCategories.find((category) =>
    category
      .trim()
      .toLowerCase()
      .normalize('NFD')
      .replace(/\p{Diacritic}/gu, '') === normalizedLabel
  );

  const categorySegment = matchedCategory ?? slugifyCategory(label);
  return `/categoria/${encodeURIComponent(categorySegment)}`;
}
        ...
        <nav className={styles.headerNav}>
          <ul className={styles.mainNav}>
            ...
            <li className={styles.electrodomesticosItem}>
              ...
              <ul className={styles.submenu}>
                <li><Link href="/categoria/tv">tv</Link></li>
                <li><Link href="/categoria/aire">aire</Link></li>
                <li><Link href="/categoria/cocina">artículos de cocina</Link></li>
                <li><Link href="/categoria/ventiladores">ventiladores</Link></li>
                <li><Link href="/categoria/biciletas">bicicletas</Link></li>
                <li><Link href="/categoria/consolas">consolas</Link></li>
